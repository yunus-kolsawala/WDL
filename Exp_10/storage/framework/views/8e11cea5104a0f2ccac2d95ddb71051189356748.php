...
<section class="text-gray-700 body-font mt-16">
		<div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
			<div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
				<h1 class="title-font font-medium text-3xl text-gray-900">Sign In facility on this page is available only for
					the Admin users</h1>
				<p class="leading-relaxed mt-4">We request the new registration to go on<a href="/signin">Signin page</a></p>
			</div>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/public/adminsignin.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cot2\resources\views/adminsignin.blade.php ENDPATH**/ ?>